...
export declare function getDataStream(): {
    ...
    simulate: {
        streamData: <chainOverride extends import("viem").Chain | undefined = undefined, accountOverride extends import("viem").Account | Address | undefined = undefined>(args: readonly [subscriber: `0x${string}`, `0x${string}`, bigint, bigint], options?: Omit<import("viem").SimulateContractParameters<readonly [{
            readonly name: "totalMessages";
            readonly type: "function";
            readonly stateMutability: "view";
            readonly inputs: readonly [];
