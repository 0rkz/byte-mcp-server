...
import { publicClient, getWalletClient, getWalletAddress, DataRegistryAbi, DataStreamAbi, SchemaRegistryAbi, PPBTokenAbi, TestnetFaucetAbi, } from "../lib/contracts.js";
...
export async function publishData(params) {
    ...
    const hash = await wallet.writeContract({
        ...
        args: [params.subscriber, payloadHash, payloadSize, maxFeeWei],
