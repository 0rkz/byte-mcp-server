    ...
    server.registerTool("byte_query_fact", {
        ...
        inputSchema: {
            ...
            max_byte_cost: z
                ...
                .max(10000)
                .optional()
                .describe("Max response payload bytes you're willing to pay for (defaults to 2000). Billed at the publisher's registered price-per-KB — read it with byte_get_publisher or byte_search_publishers before asking. Publisher refuses if can't fit answer."),
            topic_filter: z
                .string()
                .optional()
